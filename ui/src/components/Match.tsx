    ...
    <div className="match">
      <h1
        className={
          "match__matchResult " +
          (match.win
            ? "match__matchResult--victory"
            : "match__matchResult--defeat")
        }
      >
      ...
      <div className="match__player">
        <div className="match__player__champion">
          ...
          />
          <span className="match__player__champion__level">
            {match.playerStats.championLevel}
          </span>
        </div>

        <span className="match__player__header match__player__header--time">
          Time
        </span>
        <span className="match__player__matchDuration">
          {`${minTommss(match.gameDuration / 60)} minutes`}
        </span>
        ...
        <span className="match__player__header match__player__header--KDA">
          KDA
        </span>
        <span className="match__player__KDAData">
          {`${match.playerStats.kills} / ${match.playerStats.deaths} / ${match.playerStats.assists}`}
        </span>
        <span className="match__player__KDARatio">
          {`${(
            (match.playerStats.kills + match.playerStats.assists) /
            match.playerStats.deaths
          ).toFixed(2)} KDA`}
        </span>

        <span className="match__player__header match__player__header--CS">
          CS
        </span>
        <span className="match__player__CSTotal">
          {`${match.playerStats.CS} CS`}
        </span>
        <span className="match__player__CSPerMinute">
          {`${(match.playerStats.CS / (match.gameDuration / 60)).toFixed(
            1
          )} CS/min`}
        </span>

        <span className="match__player__header match__player__header--vision">
          Vision
        </span>
        <span className="match__player__visionScore">
          {`${match.playerStats.visionScore} Score`}
        </span>
        ...
        <span className="match__player__header match__player__header--damage">
          Damage
        </span>
        <span className="match__player__damageDealt">
          {`${abbreviateNumber(
            match.playerStats.totalDamageDealtToChampions
          )} Dealt`}
        </span>
        <span className="match__player__damageTaken">
          {`${abbreviateNumber(match.playerStats.totalDamageTaken)} Taken`}
        </span>

        {match.playerStats.summonerSpellIds.map(
          (summonerSpellId: any, i: any) =>
            summonerSpellId ? (
              <img
              ...
              <span
                className={`match__player__spell${i + 1} match__player__spell${
                  i + 1
                }--missing`}
              ></span>
            )
        ...
        {match.playerStats.itemIds.map((itemId: any, i: any) =>
          itemId ? (
            <img
              ...
              className={`match__player__item${i + 1}`}
              key={i}
            />
          ) : (
            <span
              className={`match__player__item${i + 1} match__player__item${
                i + 1
              }--missing`}
              key={i}
            ></span>
        ...
        {match.playerStats.trinket ? (
          <img
            src={`https://ddragon.leagueoflegends.com/cdn/11.10.1/img/item/${match.playerStats.trinket}.png`}
            className="match__player__trinket"
          />
        ) : (
          ...
          match.playerStats.perkPrimaryStyle && primaryPerkId ? (
            <img
              src={`https://ddragon.leagueoflegends.com/cdn/img/${
                perksExample[match.playerStats.perkPrimaryStyle].perks[
                  primaryPerkId
                ].icon
              }`}
              title={`${
            ...
            <span
              className={`match__player__primaryPerk${
                i + 1
              } match__player__primaryPerk${i + 1}--missing`}
              key={i}
            ></span>
          )
        )}

        {match.playerStats.secondaryPerkIds.map(
          (secondaryPerkId: any, i: any) =>
            match.playerStats.perkSecondaryStyle && secondaryPerkId ? (
              <img
                src={`https://ddragon.leagueoflegends.com/cdn/img/${
                  perksExample[match.playerStats.perkSecondaryStyle].perks[
                    secondaryPerkId
                  ].icon
                }`}
                title={`${
              ...
              <span
                className={`match__player__secondaryPerk${
                  i + 1
                } match__player__secondaryPerk${i + 1}--missing`}
                key={i}
              ></span>
            )
        )}
        ...
        {match.playerStats.statPerkIds.map((statPerkId: any, i: any) =>
          statPerkId ? (
            ...
            <span
              className={`match__player__statPerk${
                i + 1
              } match__player__statPerk${i + 1}--missing`}
              key={i}
            ></span>
          )
        )}
          ...
          <div className="match__teams__team" key={index}>
            <div className="match__teams__team__stats">
              <div className="match__teams__team__stats__stat match__teams__team__stats__stat__inhibitor">
                <img
                  className="match__teams__team__stats__stat__inhibitor__image"
                  src={`${index === 0 ? inhibitor100 : inhibitor200}`}
                />
                <span className="match__teams__team__stats__stat__inhibitor__kills">
                  {team.inhibitorKills}
                </span>
              </div>
              ...
              <div className="match__teams__team__stats__stat match__teams__team__stats__stat__tower">
                <img
                  className="match__teams__team__stats__stat__tower__image"
                  src={`${index === 0 ? tower100 : tower200}`}
                />
                <span className="match__teams__team__stats__stat__tower__kills">
                  {team.towerKills}
                </span>
              </div>
              ...
              <div className="match__teams__team__stats__stat match__teams__team__stats__stat__herald">
                <img
                  className="match__teams__team__stats__stat__herald__image"
                  src={`${index === 0 ? herald100 : herald200}`}
                />
                <span className="match__teams__team__stats__stat__herald__kills">
              ...
              <div className="match__teams__team__stats__stat match__teams__team__stats__stat__dragon">
                <img
                  className="match__teams__team__stats__stat__dragon__image"
                  src={`${index === 0 ? dragon100 : dragon200}`}
                />
                <span className="match__teams__team__stats__stat__dragon__kills">
                  {team.dragonKills}
                </span>
              </div>
              ...
              <div className="match__teams__team__stats__stat match__teams__team__stats__stat__baron">
                <img
                  className="match__teams__team__stats__stat__baron__image"
                  src={`${index === 0 ? baron100 : baron200}`}
                />
                <span className="match__teams__team__stats__stat__baron__kills">
                  {team.baronKills}
                </span>
              </div>
              ...
              {team.bans && team.bans.length ? (
                <div className="match__teams__team__stats__stat__bans">
                  {team.bans.map((ban: any, index: number) => (
                    <div
                      className="match__teams__team__stats__stat__bans__ban"
                      key={index}
                    >
                      <img
                      ...
                      />
                      <div className="match__teams__team__stats__stat__bans__ban__filter">
                        X
                      </div>
                    </div>
                  ))}
            ...
            <div className="match__teams__participants">
              {team.participants.map((participant: any, i: any) => (
                <div
                  className="match__teams__team__participants__participant"
                  key={i}
                >
                  <div className="match__teams__team__participants__participant__champion">
                    ...
                    />
                    <span className="match__teams__team__participants__participant__champion__level">
                  ...
                  <span className="match__teams__team__participants__participant__name">
                    ...
                    {participant.firstBlood && (
                      <span className="match__teams__team__participants__participant__name__firstBlood">
                        First blood
                      </span>
                    )}
                  </span>
                  ...
                  <span className="match__teams__team__participants__participant__CSTotal">
                    {`${participant.CS} CS`}
                  </span>
                  <span className="match__teams__team__participants__participant__CSPerMinute">
                    {`${(participant.CS / (match.gameDuration / 60)).toFixed(
                      1
                    )} /min`}
                  </span>
                  ...
                  <span className="match__teams__team__participants__participant__visionScore">
                    {`${participant.visionScore} Score`}
                  </span>
                  <span className="match__teams__team__participants__participant__visionData">
                    {`${
                      participant.wardsPlaced ? participant.wardsPlaced : "0"
                    }|${
                      participant.wardsKilled ? participant.wardsKilled : "0"
                    }`}
                  </span>
                  ...
                  {participant.summonerSpellIds.map(
                    (summonerSpellId: any, i: any) =>
                      summonerSpellId ? (
                        <img
                        ...
                        <span
                          className={`match__teams__team__participants__participant__spell${
                            i + 1
                          } match__teams__team__participants__participant__spell${
                            i + 1
                          }--missing`}
                          key={i}
                        ></span>
                  ...
                  {participant.itemIds.map((itemId: any, i: any) =>
                    itemId ? (
                      <img
                        src={`https://ddragon.leagueoflegends.com/cdn/11.10.1/img/item/${itemId}.png`}
                        className={`match__teams__team__participants__participant__item${
                          i + 1
                        }`}
                        key={i}
                      />
                      ...
                      <span
                        className={`match__teams__team__participants__participant__item${
                          i + 1
                        } match__teams__team__participants__participant__item${
                          i + 1
                        }--missing`}
                        key={i}
                      ></span>
                  ...
                  {participant.primaryPerkIds.map(
                    (primaryPerkId: any, i: any) =>
                      participant.perkPrimaryStyle && primaryPerkId ? (
                        <img
                          src={`https://ddragon.leagueoflegends.com/cdn/img/${
                            perksExample[participant.perkPrimaryStyle].perks[
                              primaryPerkId
                            ].icon
                          }`}
                          title={`${
                        ...
                        <span
                          className={`match__teams__team__participants__participant__primaryPerk${
                            i + 1
                          } match__teams__team__participants__participant__primaryPerk${
                            i + 1
                          }--missing`}
                          key={i}
                        ></span>
                  ...
                  {participant.secondaryPerkIds.map(
                    (secondaryPerkId: any, i: any) =>
                      participant.perkSecondaryStyle && secondaryPerkId ? (
                        <img
                          src={`https://ddragon.leagueoflegends.com/cdn/img/${
                            perksExample[participant.perkSecondaryStyle].perks[
                              secondaryPerkId
                            ].icon
                          }`}
                          title={`${
                        ...
                        <span
                          className={`match__teams__team__participants__participant__secondaryPerk${
                            i + 1
                          } match__teams__team__participants__participant__secondaryPerk${
                            i + 1
                          }--missing`}
                          key={i}
                        ></span>
                  ...
                  {participant.statPerkIds.map((statPerkId: any, i: any) =>
                    statPerkId ? (
                      ...
                      <span
                        className={`match__teams__team__participants__participant__statPerk${
                          i + 1
                        } match__teams__team__participants__participant__statPerk${
                          i + 1
                        }--missing`}
                        key={i}
                      ></span>
